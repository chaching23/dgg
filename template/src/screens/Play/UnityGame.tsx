    ...
    <SafeScreen>
      <View style={[layout.flex_1, { padding: 16 }]}> 
        <View style={{ flex: 1, borderRadius: 14, backgroundColor: '#0F0F0F', borderWidth: 1, borderColor: '#222', alignItems: 'center', justifyContent: 'center' }}>
          <Text style={[fonts.size_20, fonts.bold, { color: '#FFFFFF' }]}>{gameTitle}</Text>
        ...
        <View style={{ flexDirection: 'row' }}>
          <TouchableOpacity onPress={() => finish('LOSS')} style={{ flex: 1, backgroundColor: '#1A1A1A', paddingVertical: 14, borderRadius: 10, borderWidth: 1, borderColor: '#2A2A2A', marginRight: 8, alignItems: 'center' }}>
            <Text style={{ color: '#FF4D4D', fontWeight: '800' }}>Simulate Lose</Text>
          </TouchableOpacity>
